...
<div class="row" id="tk_02_file_read">
    <div class="col-md-2">
        <div class="form-group">
            <p>ไฟล์บทที่ 1-3</p>
            <a class="btn btn-app bg-danger" id="tk_02_file_read_1">
                <i class="fas fa-file-pdf"></i> ไฟล์บทที่ 1-3
            </a>
        </div>
    </div>
    <div class="col-md-1" id="tk_02_file_present">
        <div class="form-group">
            <p>ไฟล์นำเสนอ</p>
            <a class="btn btn-app bg-danger" id="tk_02_file_read_2">
