                        ...
                        <div class="col-md-1 col-sm-6 col-12">
                            ...
                            <div class="col-md-3 col-sm-6 col-12">
                                <div class="info-box bg-gradient-success">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-number">การยืนยันนักศึกษา</span>
                                    </div>
                                    <!-- /.info-box-content -->
                                </div>
                                <!-- /.info-box -->
                            ...
                            <div class="col-md-3 col-sm-6 col-12">
                                <div class="info-box bg-gradient-info">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-number">ติดตามความก้าวหน้า</span>
                                    </div>
                                    <!-- /.info-box-content -->
                                </div>
                                <!-- /.info-box -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6 col-12">
                                <div class="info-box bg-gradient-gray">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-number">แบบฟอร์มบันทึกคะแนน</span>
                                    </div>
                                    <!-- /.info-box-content -->
                                </div>
                                <!-- /.info-box -->
