<title>ตรวจสอบตารางสอบ อาจารย์</title>
...
<body class="hold-transition sidebar-mini">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>ตรวจสอบตารางสอบ อาจารย์</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="<?= site_url('/'); ?>">หน้าหลัก</a></li>
                            <li class="breadcrumb-item active">ตรวจสอบตารางสอบ อาจารย์</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                ...
                                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="custom-tabs-one-messages-tab" data-toggle="pill"
                                            ...
                                            onclick="display_type3()">สอบ 100</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="card-body">
    ...
    <script>
        function display_type1() {
            ...
            $.ajax({
                type: "POST",
                url: "<?= site_url('teacher/testlist/getdata/1') ?>",
    ...
    <script>
        ...
        function display_type2() {
            if (display__type2 == 0) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?= site_url('teacher/testlist/getdata/2') ?>",
                    success: function (data) {
                        $("#overlay").hide()
                        if (data === false) {
    ...
    <script>
        ...
        function display_type3() {
            if (display__type3 == 0) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?= site_url('teacher/testlist/getdata/3') ?>",
                    success: function (data) {
                        $("#overlay").hide()
                        if (data === false) {
        ...
        function confirm_Alert(text, url) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '<?= base_url('/teacher/testlist/changestatus/') ?>' + url,
                        headers: {
