...
<body class="hold-transition sidebar-mini">
    ...
    <script>
        function load_modal(load_check, data_encode) {
            ...
            $(".modal-body #div_room").show();

            modalBody.find('#name_user, #lastname_user, #email_user, #phone_user, #room_user').val('');
            ...
            switch (load_check) {
                ...
                case 2:
                    ...
                    modalBody.find('#room_user').val(rowData.room_user);
                    textPassword.show();
                ...
                case 3:
                    ...
                    $(".modal-body #url_route_file").val("admin/user/create_file/1");
                    break;
            }
        }
    </script>
