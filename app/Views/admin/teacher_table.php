    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>การจัดการข้อมูลอาจารย์</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="<?= site_url('/'); ?>">หน้าหลัก</a></li>
                            <li class="breadcrumb-item active">การจัดการข้อมูลอาจารย์</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a class="btn btn-app bg-success" data-toggle="modal" data-target="#modal-default"
                                ...
                                <i class="fas fa-file-csv"></i> เพิ่มข้อมูลอาจารย์ด้วยไฟล์
                            </a>
                            <a class="btn btn-app bg-success" data-toggle="modal" data-target="#modal-default"
                                onclick="load_modal(1)">
                                <i class="fas fa-plus-square"></i> เพิ่มข้อมูลอาจารย์
                            </a>
                        </div>
                        <!-- /.card-tools -->
                    </div>
        ...
        function load_modal(load_check, data_encode) {
            ...
            switch (load_check) {
                case 1:
                    ...
                    textPassword.hide();
                    modalHeader.find('#title_modal').text("สร้างข้อมูลอาจารย์");
                    modalBody.find('#url_route').val("admin/user/create/2");
                    switchStatus.hide();
                    break;
                case 2:
                    crud_user.show();
                    ...
                    modalHeader.find('#title_modal').text("แก้ไขข้อมูลอาจารย์");
                ...
                case 3:
                    ...
                    $(".modal-body #url_route_file").val("admin/user/create_file/2");
                    break;
            }
        }
    </script>
    ...
    <script>
        function getTableData() {
            ...
            $('#example1').DataTable({
                ...
                'serverSide': true,
                'ajax': {
                    'url': "<?php echo site_url('admin/user/getdata/2'); ?>",
                    'type': 'GET',
                    'dataSrc': 'data',
                },
                "responsive": true,
